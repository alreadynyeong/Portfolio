...
export const ProjectList: Project[] = [
  ...
  },
  {
    ...
    duration: "2023.09.19~2024.03.20",
    part: ["Frontend"],
    ...
    카테고리, 검색어, 최신검색어를 통한 검색을 구현했습니다.
    최신검색어는 localStorage를 사용해 최대 7개까지 저장했습니다.

    리뷰의 상세보기 페이지를 구현하면서 Swiper를 사용해 이미지 슬라이드를 구현했습니다.
    홈에서는 시간에 따른 자동 슬라이드와 스와이프를 활용한 뉴스배너를 구현했습니다.

    이메일과 이메일 인증 및 추가정보를 입력해 회원가입을 구현했습니다.

    관심카테고리, 좋아요한 리뷰, 스크랩 리뷰, 내가 쓴 리뷰 등의 조회를 구현했습니다.

    각 유저의 프로필 화면을 구현했으며, 유저의 정보 수정을 구현했습니다.
    ...
    swipe, slide 등의 기능을 구현하면서, 사용자 경험에 대해 고민하게 되었습니다.
    `,
    people: `
